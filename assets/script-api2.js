    ...
    fetch(eventsUrl)
        ...
        .then(function (data) {
            ...
            function appendEvents(num, index) {
                ...
                $('#attraction-' + num).append('<p class= "is-size-5 has-text-weight-b">' + 'When? ' + data._embedded.events[index].dates.start.localDate + '</p>');
